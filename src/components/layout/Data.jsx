import { Author1, Author2, Author3, Author4, Project1, Project2, Project3, Project4, Blog1, Blog2, Blog3 } from "../layout/helper";
...
export const blogItems = [
   {
      ...
      date: '13 Jan, 21',
      name: 'Ashikur Verma',
      title: 'Leverage agile provide to a robust',
   },
   {
      id: 'b2',
      comments: '3',
   ...
   },
   {
      ...
      title: 'Digital divide with additional technologies',
   },
   {
      id: 'b5',
      comments: '7',
      ...
      date: '18 Jun, 22',
      name: 'Mahesh Kohli',
      title: 'The technological infrastructure',
   },
   {
      id: 'b6',
      comments: '2',
...
export const testimonialItems = [
   {
      ...
      quote: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Mollitia earum optioquisquam quasi, sit iure tenetur aliquam libero maxime asperiores dolor quam rerum nostrum esse omnis!'
   },
   {
      id: 't2',
      imgSrc: Author2,
...
export const featureItems = [
   {
      ...
      description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias, commodi.',
      svg: <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 576 512">
         <path
   ...
   },
   {
      ...
      description: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Molestias, commodi.',
      svg: <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 512 512">
         <path
