            ...
            <div className="sidebar-wrapper">
               ...
               <nav aria-labelledby="Secondary Navigation">
                  ...
                  <ul className="nav-list">
                     <li className="sidebar-item"><Link to="/" className="sidebar-link">Home</Link></li>
                     <li className="sidebar-item"><Link to="/about" className="sidebar-link">About Us</Link></li>
                     <li className="sidebar-item">
                        <Link to="/servicepage" className="sidebar-link">Services
                        ...
                        <ul className="dropdown-sidemenu">
                           <li className="dropdown-item"><Link to="#!" className="dropdown-link">Website
                              Development</Link></li>
                           <li className="dropdown-item"><Link to="#!" className="dropdown-link">App Development</Link>
                           </li>
                           <li className="dropdown-item"><Link to="#!" className="dropdown-link">UI/UX Design</Link>
                           </li>
                           <li className="dropdown-item"><Link to="#!" className="dropdown-link">SEO & Content
                              Writing</Link></li>
                           <li className="dropdown-item"><Link to="#!" className="dropdown-link">Graphic Design</Link>
                           </li>
                           <li className="dropdown-item"><Link to="#!" className="dropdown-link">Digital
                              Marketing</Link></li>
                        </ul>
                     </li>
                     <li className="sidebar-item">
                        <Link to="/portfolio" className="sidebar-link">Portfolio
                           <figure className="dropdown">
                     ...
                     <li className="sidebar-item">
                        <Link to="/blogpage" className="sidebar-link">Blog
                           <figure className="dropdown">
                              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="12"
                                 viewBox="0 0 256 512">
                                 <path
                        ...
                        <ul className="dropdown-sidemenu">
                           ...
                           <li className="dropdown-item"><Link to="#!" className="dropdown-link">Product Detail</Link>
                           </li>
