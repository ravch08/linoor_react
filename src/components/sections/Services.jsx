         ...
         <div className="container">
            ...
            <div className="service-wrapper">
               ...
               <div className="service-content">
                  ...
                  <h3>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.
                  </h3>
            ...
            <div className="service-wrapper">
               <div className="service-content">
                  ...
                  <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. fur hat and fur boa who sat upright, raising a heavy fur muff that covered.
                  </p>
                  ...
                  <Link to="#!" className="btn-gradient">GET STARTED</Link>
               </div>

               <figure><img loading="lazy" src={Service2} alt="about-nine-1-1" /></figure>
            </div>
